...
class Trainer(TorchCommander):
    ...
    def train_model(self, name, model, train_loader, val_loader, eval_fn,
                    ...
                    optimizer=None, scheduler_fn=None, short=False):
        ...
        for epoch in range(1, self.args.epoch + 1):
            ...
            for k, metrics_fn in epoch_metrics.items():
                train_history[k].append(metrics_fn(epoch_outputs.detach(), epoch_labels.detach()))
            ...
            if val_loader:
                ...
                val_message = ' '.join([f'{k}:{v[-1]}' for k, v in val_history.items()])
