...
class Trainer(metaclass=ABCMeta):
    def __init__(self, model_name, loaders, trainer_name=None, report_image=False,
                 log_dir='data/logs', device='cpu', save_period=10, **kwargs):
    ...
    def require_writer(self):
        if not self.writer:
            d = os.path.join(self.log_dir, self.trainer_name)
            print(f'Using log dir: {d}')
