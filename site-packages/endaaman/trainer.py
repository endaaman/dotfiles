...
class Checkpoint(NamedTuple):
    ...
    def full_name(self):
        if self.suffix:
            return self.model_name + '_' + self.suffix
        return self.model_name


class Trainer(metaclass=ABCMeta):
    def __init__(self, model_name, loaders, trainer_name=None, log_dir='data/logs', device='cpu', save_period=10, show_fig=False, suffix='', **kwargs):
    ...
    def get_out_dir(self):
        return os.path.join('out', self.with_suffix(self.trainer_name))
    ...
    def require_writer(self):
        if not self.writer:
            d = os.path.join(self.log_dir, self.with_suffix(self.trainer_name))
