...
[core]
s0_active_plugins = core;composite;opengl;decor;resize;imgpng;mousepoll;place;ezoom;matecompat;wall;commands;move;grid;session;regex;compiztoolbox;snap;animation;staticswitcher;workarounds;fade;scale;
...
[commands]
s0_command0 = xdotool click 1
s0_command1 = setxkbmap
s0_command2 = mate-screenshot -a
s0_command3 = gyazo
s0_command4 = 
s0_command5 = 
s0_command6 = 
...
s0_run_command0_key = <Super>Return
s0_run_command1_key = Disabled
s0_run_command2_key = <Super>p
s0_run_command3_key = <Super>g
