...
[core]
s0_active_plugins = core;composite;crashhandler;opengl;compiztoolbox;decor;grid;imgjpeg;imgpng;imgsvg;inotify;matecompat;mousepoll;move;obs;place;regex;resize;resizeinfo;snap;staticswitcher;text;vpswitch;wall;animation;animationaddon;animationjc;animationplus;commands;dbus;notification;shelf;workarounds;
s0_outputs = 2560x1440+1920+0;1920x1080+0+293;
...
s0_inc_button = <Alt><Super>Button1
