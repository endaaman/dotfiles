    ...
    def prepare(self):
        if self.config.model_name == 'custom':
            ...
            model = timm.create_model(
                ...
                pretrained=False,
                in_chans=IN_CHANS_MAP[self.config.dataset],
                num_classes=10
            )
...
class CLI(BaseMLCLI):
    ...
    def run_train(self, a:TrainArgs):
        if a.dataset == 'number':
            ...
            DS_DIR = './datasets/MNIST'
        elif a.dataset == 'fashion':
            DS_CLASS = datasets.FashionMNIST
            DS_DIR = './datasets/FashionMNIST'
        elif a.dataset == 'cifar10':
            DS_CLASS = datasets.CIFAR10
            DS_DIR = './datasets/CIFAR10/'
        else:
            raise RuntimeError('Invalid dataset', a.dataset)
        ...
        t = Trainer(
            config=config,
            out_dir=f'out/mnist/{a.dataset}/{name}',
            train_dataset=dss[0],
            val_dataset=dss[1],
